...
/* ─── tokens ─────────────────────────────────── */
:root {
  --bg:   #020509; --bg1: #050a14; --bg2: #070d1c;
  --bg3:  #0a1224; --bg4: #0e182e;
...
/* ─── typography ───────────────────────────────── */
h1 { font-family: var(--ff) !important; font-size: 1.75rem !important;
     font-weight: 700 !important; color: var(--t0) !important;
     letter-spacing: -.025em !important; line-height: 1.15 !important; }
h2 { font-family: var(--ff) !important; font-size: 1.1rem !important;
...
[data-testid="stMetricValue"] {
  font-family: var(--ff) !important; font-size: 1.9rem !important;
  font-weight: 700 !important; color: var(--t0) !important;
  letter-spacing: -.035em !important;
}
[data-testid="stMetricLabel"] {
  color: var(--t3) !important; font-size: .6rem !important;
...
[data-testid="stFileUploadDropzone"] {
  ...
  border-radius: 14px !important; padding: 3rem 2rem !important;
...
.stTabs [data-baseweb="tab-list"] {
  ...
  gap: 0 !important; padding: 0 .75rem !important;
}
.stTabs [data-baseweb="tab"] {
  ...
  font-size: .72rem !important; padding: .8rem 1.2rem !important;
...
.stTabs [aria-selected="true"] {
  color: var(--g3) !important; border-bottom: 2px solid var(--g2) !important;
}
.stTabs [data-baseweb="tab-panel"] {
  background: var(--bg2) !important;
  border: 1px solid var(--b2) !important; border-top: none !important;
  border-radius: 0 0 var(--r) var(--r) !important; padding: 1.4rem !important;
}
...
.streamlit-expanderHeader {
  ...
  font-size: .83rem !important; color: var(--t1) !important;
...
[data-testid="stRadio"] label {
  background: var(--bg3) !important; border: 1px solid var(--b2) !important;
  border-radius: 6px !important; padding: .3rem .75rem !important;
  font-size: .72rem !important; font-family: var(--ff) !important;
  font-weight: 500 !important; color: var(--t2) !important;
  transition: all .15s !important; cursor: pointer !important;
}
[data-testid="stRadio"] label:hover {
  border-color: var(--b3) !important; color: var(--t1) !important;
}
...
.ph h1 { margin: 0; }
.ph-eye {
  font-family: var(--fi); font-size: .56rem; font-weight: 500;
  letter-spacing: .24em; text-transform: uppercase;
  color: var(--g2); margin-bottom: .22rem;
  animation: drop .38s .04s ease both; animation-fill-mode: both;
}
.ph-bar {
  height: 1px; margin: .28rem 0 1.5rem;
  background: linear-gradient(90deg, var(--g2) 0%, var(--b2) 28%, transparent);
  animation: bar .6s .08s ease both; animation-fill-mode: both;
}

/* KPI card */
.kc {
  background: var(--bg3); border: 1px solid var(--b2);
  border-radius: var(--r); padding: .9rem 1.1rem 1rem;
  position: relative; overflow: hidden;
  animation: rise .38s ease both; animation-fill-mode: both;
...
/* per-color overrides */
.kc.gold  { border-color: rgba(184,135,12,.3);  }
.kc.gold::before  { background: linear-gradient(90deg, var(--g2),  transparent 70%); }
.kc.gold::after   { background: linear-gradient(160deg, rgba(184,135,12,.05) 0%, transparent 55%); }
.kc.gold:hover    { border-color: rgba(212,160,24,.5); }
.kc.red   { border-color: rgba(184,32,32,.3);  }
.kc.red::before   { background: linear-gradient(90deg, var(--r2),  transparent 70%); }
.kc.red::after    { background: linear-gradient(160deg, rgba(184,32,32,.05)  0%, transparent 55%); }
.kc.red:hover     { border-color: rgba(232,64,64,.45); }
.kc.ora   { border-color: rgba(168,72,8,.3);   }
.kc.ora::before   { background: linear-gradient(90deg, var(--o2),  transparent 70%); }
.kc.ora::after    { background: linear-gradient(160deg, rgba(168,72,8,.05)   0%, transparent 55%); }
.kc.ora:hover     { border-color: rgba(208,96,32,.45); }
.kc.grn   { border-color: rgba(8,104,56,.3);   }
.kc.grn::before   { background: linear-gradient(90deg, var(--gn2), transparent 70%); }
.kc.grn::after    { background: linear-gradient(160deg, rgba(8,104,56,.05)   0%, transparent 55%); }
.kc.grn:hover     { border-color: rgba(16,160,88,.45); }
.kc.blu   { border-color: rgba(12,52,152,.3);  }
.kc.blu::before   { background: linear-gradient(90deg, var(--bl2), transparent 70%); }
.kc.blu::after    { background: linear-gradient(160deg, rgba(12,52,152,.05)  0%, transparent 55%); }
.kc.blu:hover     { border-color: rgba(26,96,208,.45); }

.kc-n {
  font-family: var(--ff); font-size: 2rem; font-weight: 700; line-height: 1.1;
  letter-spacing: -.04em; position: relative; z-index: 1;
  animation: numup .38s .1s ease both; animation-fill-mode: both;
}
.kc-l {
  font-family: var(--fi); font-size: .58rem; font-weight: 500;
  text-transform: uppercase; letter-spacing: .16em;
  color: var(--t3); margin-top: 4px; position: relative; z-index: 1;
}
.kc.gold .kc-n { color: var(--g4);  }
.kc.red  .kc-n { color: var(--r3);  }
.kc.ora  .kc-n { color: var(--o3);  }
.kc.grn  .kc-n { color: var(--gn3); }
.kc.blu  .kc-n { color: var(--bl3); }

/* section label */
.sl {
  font-family: var(--fi); font-size: .56rem; font-weight: 600;
...
.ps {
  background: var(--bg3); border: 1px solid var(--b2);
  border-radius: 8px; padding: .55rem .95rem .6rem;
  min-width: 78px; position: relative; overflow: hidden;
  animation: scale .3s ease both; animation-fill-mode: both;
...
.ps.red::before    { background: var(--r2); }
.ps.ora::before    { background: var(--o2); }
.ps.grn::before    { background: var(--gn2); }
.ps.blu::before    { background: var(--bl2); }
.ps-n { font-family: var(--ff); font-size: 1.6rem; font-weight: 700;
  line-height: 1; letter-spacing: -.03em; }
.ps-l { font-family: var(--fi); font-size: .55rem; text-transform: uppercase;
  letter-spacing: .13em; color: var(--t3); margin-top: 3px; }
.ps.red .ps-n { color: var(--r3); }
.ps.ora .ps-n { color: var(--o3); }
.ps.grn .ps-n { color: var(--gn3); }
.ps.blu .ps-n { color: var(--bl3); }

/* info card */
.ic {
  background: var(--bg3); border: 1px solid var(--b2);
  border-radius: 12px; padding: 1.25rem 1.5rem;
  font-family: var(--fi); font-size: .8rem;
  color: var(--t2); line-height: 1.9;
  animation: push .38s ease both; animation-fill-mode: both;
}
.ic-t { font-family: var(--ff); font-size: .56rem; font-weight: 600;
  letter-spacing: .2em; text-transform: uppercase; color: var(--g3); margin-bottom: .35rem; }

/* success / all-clear */
.succ {
  background: linear-gradient(135deg, rgba(8,104,56,.13), rgba(8,104,56,.04));
  border: 1px solid rgba(8,104,56,.3); border-radius: var(--r);
  padding: .9rem 1.4rem; color: var(--gn4); font-family: var(--ff);
  font-size: .88rem; font-weight: 500;
  animation: ok .48s cubic-bezier(.34,1.56,.64,1) both;
  display: flex; align-items: center; gap: .65rem;
}
.allclear {
  background: rgba(8,104,56,.04); border: 1px solid rgba(8,104,56,.12);
  border-radius: var(--r); padding: 1.6rem;
  text-align: center; color: var(--gn3);
  font-family: var(--ff); font-size: .88rem; font-weight: 500;
}

/* filter count */
.fc {
  font-family: var(--fm); font-size: .62rem; color: var(--t3);
  margin-bottom: .6rem; line-height: 1.6;
}
.fc b  { color: var(--t1); }
.fc .od { color: var(--r3); font-weight: 700; }
.fc .hp { color: var(--o3); font-weight: 700; }
.fc .ok { color: var(--gn3); font-weight: 700; }
...
.logo-sub { font-family: var(--fi); font-size: .52rem; text-transform: uppercase;
  letter-spacing: .2em; color: var(--t3); margin-top: 2px; }
.logo-hr  { height: 1px; margin: 1rem 0;
  background: linear-gradient(90deg, var(--g2), transparent); }

.vc {
  display: flex; align-items: center; justify-content: space-between;
  background: var(--bg3); border: 1px solid var(--b2);
  border-radius: 6px; padding: .44rem .7rem; margin-bottom: .22rem;
  transition: all .16s; animation: push .22s ease both; animation-fill-mode: both;
}
.vc:hover { border-color: var(--b3); background: var(--bg4); }
.vc.c { border-left: 2px solid var(--r2); }
.vc.w { border-left: 2px solid var(--o2); }
.vc.s { border-left: 2px solid var(--gn2); }
.vc-nm { font-family: var(--ff); font-size: .69rem; font-weight: 600;
...
.vt  { font-family: var(--fm); font-size: .52rem; font-weight: 500;
  padding: 1px 5px; border-radius: 3px; }
.vt.o  { background: rgba(184,32,32,.15);  color: var(--r3); }
.vt.h  { background: rgba(168,72,8,.15);   color: var(--o3); }
.vt.k  { background: rgba(8,104,56,.15);   color: var(--gn3); }

/* meta line */
.ml { display: flex; gap: 1.1rem; flex-wrap: wrap;
  font-family: var(--fm); font-size: .61rem; color: var(--t3); margin: .55rem 0 0; }
...
# ═══════════════════════════════════════════════════════════════════
#  PARSER  (cell._tc identity — merged-cell safe)
# ═══════════════════════════════════════════════════════════════════

def _ucells(row):
    """Unique cells only — merged cells share _tc, skip duplicates."""
    seen, out = set(), []
...
def _date(raw: str) -> Optional[str]:
    ...
    n = re.sub(r"\bSEPT\b","SEP", s, flags=re.I)
    n = re.sub(r"\bJUNE\b","JUN", n, flags=re.I)
    n = re.sub(r"\bJULY\b","JUL", n, flags=re.I)
    for fmt in ("%d %b %y","%d %B %y","%d %b %Y","%d %B %Y",
                "%d/%m/%y","%d/%m/%Y","%d-%m-%y","%d-%m-%Y",
                "%b %Y","%B %Y","%Y-%m-%d"):
        for v in (n, n.upper(), n.title(), s, s.upper()):
            try: return datetime.strptime(v, fmt).strftime("%Y-%m-%d")
            except ValueError: pass
    return None  # reject anything unparseable
...
def parse_doc_bytes(docx_bytes: bytes) -> dict:
    ...
    if not doc.tables: raise ValueError("No tables — is this a TEC-004 report?")
    ...
    # ── TABLE 0: Main Engine ──────────────────────────────────────
    me_tot = me_mo = None; comps = []; seq = 0
    t0 = doc.tables[0]

    for _, cell in _ucells(t0.rows[0]):
        x = cell.text
    ...
    cyl_cols = []
    if len(t0.rows) > 1:
        for ci, cell in _ucells(t0.rows[1]):
            if m := re.search(r"CYL\s*\.?\s*No\s*\.?\s*(\d+)", cell.text.strip(), re.I):
                cyl_cols.append((ci, f"Cyl {int(m.group(1))}"))

    rows = t0.rows; i = 2
    while i < len(rows) - 1:
        r1 = {ci: cell.text.strip() for ci, cell in _ucells(rows[i])}
        r2 = {ci: cell.text.strip() for ci, cell in _ucells(rows[i+1])} if i+1 < len(rows) else {}
        nm = r1.get(0,"")
        if not _is_comp(nm): i += 1; continue
        if r1.get(2,"") == "1" and r2.get(2,"") == "2" and nm == r2.get(0,""):
            p = _per(r1.get(1,""))
            for ci, lbl in cyl_cols:
                d = _date(r1.get(ci,""))
                h = _hrs(r2.get(ci,""))
                if d is None and h is None: continue
                comps.append({"seq":seq,"category":"MAIN_ENGINE","engine_label":"ME",
                    "unit":lbl,"description":nm,"periodicity":p,
    ...
    if len(doc.tables) > 1:
        ...
        for row in t1.rows:
            ...
            for sec, dc, dtc, hrc in [("TURBOCHARGER / AUX BOILER",0,1,3),
                                       ("COOLERS / EXH GAS BOILER",5,6,8),
                                       ("A/C & COMPRESSORS",10,11,12)]:
                desc = cells.get(dc,"")
                if not desc or desc.upper() in SK: continue
                dv = cells.get(dtc,""); hv = cells.get(hrc,"")
                if dv or hv:
                    oe.append({"section":sec,"description":desc,"periodicity":"","last_date":dv,"run_hrs":hv})

    # ── TABLE 2: Auxiliary Engines ────────────────────────────────
    if len(doc.tables) > 2:
        t2 = doc.tables[2]; rows2 = t2.rows; eblk = []
        if rows2:
            hdr = {ci: cell.text.strip() for ci, cell in _ucells(rows2[0])}
            seen_e = set()
            for ci, txt in hdr.items():
                if m := re.search(r"Aux\.\s*Engine\s*No\.?\s*(\d+)", txt, re.I):
                    lbl = f"AUX-{int(m.group(1))}"
                    if lbl not in seen_e:
                        seen_e.add(lbl); eblk.append((lbl, ci))
        cmap = {}
        if len(rows2) > 4:
            r4 = {ci: cell.text.strip() for ci, cell in _ucells(rows2[4])}
            for ei, (elbl, es) in enumerate(eblk):
                ee = eblk[ei+1][1] if ei+1 < len(eblk) else max(r4.keys(), default=0)+1
                sc2: list = []
                for ci, txt in r4.items():
                    if es <= ci < ee:
                        if m := re.search(r"(\d+)", txt):
                            cn = int(m.group(1))
                            if cn not in sc2:
                                sc2.append(cn); cmap[ci] = (elbl, f"Cyl {cn}")
        i2 = 5
        while i2 < len(rows2) - 1:
            r1 = {ci: cell.text.strip() for ci, cell in _ucells(rows2[i2])}
            r2 = {ci: cell.text.strip() for ci, cell in _ucells(rows2[i2+1])} if i2+1 < len(rows2) else {}
            nm = r1.get(0,"")
            if not _is_comp(nm): i2 += 1; continue
            if r1.get(2,"") in ("1","2") and nm == r2.get(0,""):
                p = _per(r1.get(1,""))
                for ci, (elbl, ulbl) in cmap.items():
                    d = _date(r1.get(ci,""))
                    h = _hrs(r2.get(ci,""))
                    if d is None and h is None: continue
                    comps.append({"seq":seq,"category":"AUX_ENGINE","engine_label":elbl,
                        "unit":ulbl,"description":nm,"periodicity":p,
                        "last_oh_date":d,"last_oh_hrs":h,"hrs_since":h,
                        "pct_used":_pct(h,p),"status":_stat(h,p)})
                    seq += 1
                i2 += 2
    ...
    return {"vessel_name":vn,"report_date":rd,"me_total_hrs":me_tot,"me_this_month":me_mo,
...
# ═══════════════════════════════════════════════════════════════════
#  TABLE ENGINE — dynamic styling (works for any column count)
# ═══════════════════════════════════════════════════════════════════
...
# Per-column style rules — callable with theme dict
_CS = {
...
def build_table(df: pd.DataFrame, mode: str = "seq", include_vessel: bool = False) -> pd.DataFrame:
    """
    Build display table.
    mode: 'seq' = document order | 'matrix' = component→cyl | 'priority' = critical first
    """
    if df.empty:
...
def style_table(df: pd.DataFrame):
    """Dynamic row styling — adapts to whatever columns are present."""
...
def render_table(df, mode="seq", include_vessel=False, height=None):
    """Single entry point — always renders correctly regardless of columns."""
...
def ph(title, eyebrow=""):
    eye = f'<div class="ph-eye">{eyebrow}</div>' if eyebrow else ""
    return f'<div class="ph">{eye}<h1>{title}</h1></div><div class="ph-bar"></div>'
...
with st.sidebar:
    ...
    if vessels:
        ...
        if not smry.empty:
            ...
            st.markdown('<div style="font-family:var(--fi);font-size:.52rem;'
                        'text-transform:uppercase;letter-spacing:.2em;'
                        'color:var(--t3);margin-bottom:.4rem">Vessel Status</div>',
                        unsafe_allow_html=True)
    ...
    st.markdown(f'<div style="font-family:var(--fm);font-size:.55rem;color:var(--t3)">'
                f'{db_kb:.0f} kb · {len(vessels)} vessels · v5.2</div>',
                unsafe_allow_html=True)
...
if page == "Upload Report":
    ...
    with c_info:
        ...
        <div class="ic">
          ...
          ✦ Aux engines (up to 3 &times; 7 cylinders)<br>
    ...
    if uploaded:
        ...
        <div class="ps-row">
          ...
          <div class="ps blu" style="animation-delay:.18s">
            <div class="ps-n">{noe}</div><div class="ps-l">Other Equip</div></div>
        </div>""", unsafe_allow_html=True)
...
# ═══════════════════════════════════════════════════════════════════
    ...
    with f1:
        vf = st.selectbox("Vessel",
            ["All Fleet"] + sorted(all_comp["vessel_name"].unique().tolist()), key="ov_v")
    with f2:
        sf = st.selectbox("Status",
            ["All","Overdue only","High Priority +","OK only"], key="ov_s")
    with f3:
        cf = st.selectbox("Engine type",
            ["All","Main Engine","Aux Engines"], key="ov_c")
    with f4:
        cpf = st.selectbox("Component",
            ["All"] + sorted(all_comp["description"].unique().tolist()), key="ov_cp")

    sort_opt = st.radio("Sort",
...
# ═══════════════════════════════════════════════════════════════════
    ...
    with tabs[0]:
        st.markdown(sl("Overdue and High Priority — Most Critical First"),
                    unsafe_allow_html=True)
        alerts = df[df["status"].isin(["OVERDUE","HIGH PRIORITY"])]
        if alerts.empty:
            st.markdown('<div class="allclear">All components within acceptable limits</div>',
                        unsafe_allow_html=True)
        else:
    ...
    with tabs[1]:
        ...
        if me.empty: st.info("No Main Engine data.")
            ...
            st.markdown(sl("Main Engine"), unsafe_allow_html=True)
            ...
            with fc_: mr=st.radio("Sort",["Report","Matrix","Priority"],horizontal=True,key="me_r")
            v=me.copy()
            ...
            mmap={"Report":"seq","Matrix":"matrix","Priority":"priority"}
    ...
    with tabs[2]:
        ...
        if aux.empty: st.info("No Aux Engine data.")
            ...
            st.markdown(sl("Auxiliary Engines"), unsafe_allow_html=True)
            fa,fb,fc_ = st.columns(3)
            ...
            with fc_: ar=st.radio("Sort",["Report","Matrix","Priority"],horizontal=True,key="ae_r")
            v=aux.copy()
